...
- **Ubuntu Server 22.04**, 2023-06-24
```
...
- **AlmaLinux 9.2**, 2023-06-24, with SELinux set to permissive
```
...
- **Rocky 9.1**, 2023-06-24, with SELinux set to permissive
```
dnf group install "Development Tools"
dnf install cmake hwloc-devel libdb-devel motif-devel ncurses-devel openssl-devel pam-devel rsync systemd-devel wget
...
- **AlmaLinux 8.8** and **Rocky 8.8**, 2023-06-24, with SELinux set to permissive
```
dnf group install "Development Tools"
...
- **CentOS 7.9.2009**, 2023-06-24, with SELinux set to permissive
```
