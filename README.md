...
- **AlmaLinux 8.10** and **Rocky 8.10**, 2025-01-12, with SELinux set to permissive
```
...
- **AlmaLinux 9.5**, 2025-01-12, with SELinux set to permissive
```
dnf group install "Development Tools"
...
- **Rocky 9.5**, 2025-01-12, with SELinux set to permissive
```
dnf group install "Development Tools"
dnf install cmake hwloc-devel libdb-devel motif-devel ncurses-devel openssl-devel pam-devel rsync systemd-devel wget
...
- **Debian Bookworm/Bullseye**, 2025-01-12
```
...
- **Ubuntu Server 24.04, 22.04, 20.04**, 2025-01-12
```
