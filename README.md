...
- **CentOS 7.9.2009**, 2023-11-11, with SELinux set to permissive
```
...
- **AlmaLinux 8.8** and **Rocky 8.8**, 2023-11-11, with SELinux set to permissive
```
...
- **AlmaLinux 9.2**, 2023-11-11, with SELinux set to permissive
```
dnf group install "Development Tools"
...
- **Rocky 9.2**, 2023-11-11, with SELinux set to permissive
```
dnf group install "Development Tools"
dnf install cmake hwloc-devel libdb-devel motif-devel ncurses-devel openssl-devel pam-devel rsync systemd-devel wget
...
- **Debian Bookworm/Bullseye**, 2023-11-11
```
...
- **Ubuntu Server 23.04, 22.04, 20.04**, 2023-11-11
```
