...
- **Ubuntu Server 22.04**, 2023-05-06
```
...
- **AlmaLinux 9.1**, 2023-05-06, with SELinux set to permissive
```
...
- **AlmaLinux 8.7** and **Rocky 8.7**, 2023-05-06, with SELinux set to permissive
```
dnf group install "Development Tools"
...
- **CentOS 7.9.2009**, 2023-05-06, with SELinux set to permissive
```
