...
- **CentOS 7.9.2009**, 2024-06-08, with SELinux set to permissive
```
...
- **AlmaLinux 8.9** and **Rocky 8.9**, 2024-06-08, with SELinux set to permissive
```
...
- **AlmaLinux 9.4**, 2024-06-08, with SELinux set to permissive
```
dnf group install "Development Tools"
...
- **Rocky 9.4**, 2024-06-08, with SELinux set to permissive
```
dnf group install "Development Tools"
dnf install cmake hwloc-devel libdb-devel motif-devel ncurses-devel openssl-devel pam-devel rsync systemd-devel wget
...
- **Debian Bookworm/Bullseye**, 2024-06-08
```
...
- **Ubuntu Server 24.04, 22.04, 20.04**, 2024-06-08
```
