...
- **AlmaLinux 10.1**, 2026-04-11, with SELinux set to permissive
```
...
- **Rocky 10.1**, 2026-04-11, with SELinux set to permissive
```
dnf group install "Development Tools"
dnf install cmake hwloc-devel ncurses-devel openssl-devel pam-devel rsync systemd-devel wget
dnf install https://dl.fedoraproject.org/pub/epel/10/Everything/x86_64/Packages/l/libdb-5.3.28-64.el10_1.x86_64.rpm
...
- **AlmaLinux 9.7**, 2026-04-11, with SELinux set to permissive
```
dnf group install "Development Tools"
...
- **Rocky 9.7**, 2026-04-11, with SELinux set to permissive
```
dnf group install "Development Tools"
dnf install cmake hwloc-devel libdb-devel ncurses-devel openssl-devel pam-devel rsync systemd-devel wget
...
- **AlmaLinux 8.10** and **Rocky 8.10**, 2026-04-11, with SELinux set to permissive
```
dnf group install "Development Tools"
...
- **Debian Trixie/Bookworm/Bullseye**, 2026-04-11
```
...
- **Ubuntu Server 24.04, 22.04, 20.04**, 2026-04-11
```
